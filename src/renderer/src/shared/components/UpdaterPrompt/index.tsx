 ...
 * finished downloading. POS-friendly: "Later" simply hides it — the update is
 * applied when the app is next closed (autoInstallOnAppQuit) — while
 * "Restart now" quits and installs immediately.
 */
const UpdaterPrompt = () => {
