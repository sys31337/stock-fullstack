...
const InvoiceModal: React.FC<InvoiceModalProps> = ({ isOpen, onClose, initialHeldData, heldReceiptId, onSuccess, convertFromOrder }) => {
  ...
  const handleMinimize = () => {
    holdReceipt({
      ...
      state: state
    }, 'INVOICE', `Invoice #${values.orderId}`, heldReceiptId);
