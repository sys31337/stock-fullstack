...
const createCustomerSchema = Joi.object({
  ...
  daira: string.optional().allow(''),
  baladiya: string.optional().allow(''),
  addressLat: Joi.number().optional().allow(null),
  addressLng: Joi.number().optional().allow(null),
  hasWhatsapp: Joi.boolean().optional().default(false),
  whatsapp: string.optional().allow(''),
  viber: string.optional().allow(''),
  telegram: string.optional().allow(''),
