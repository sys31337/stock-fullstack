...
const createOne = async (req: IUserIdRequest, res: Response, next: NextFunction) => {
  try {
    ...
    // _id (generated by the client and preserved by the host) guarantees client
    // and host create the same reference, so sync replays do not duplicate
    // movements and statistics stay consistent across peers.
